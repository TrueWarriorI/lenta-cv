...
class Preprocessor:
    ...
    def process(
        ...
        # ── Шаг 4: Масштабирование для OCR ──────────────────────────────
        # Целевая ширина кропа для хорошего OCR — 600px.
        # Меньше: апскейл через INTER_LANCZOS4 (меньше артефактов чем CUBIC).
        # Больше: даунскейл через INTER_AREA.
        TARGET_WIDTH = 600
        if cw < TARGET_WIDTH:
            ...
            ch, cw = new_h, new_w
        elif cw > cfg.max_ocr_width or ch > cfg.max_ocr_height:
